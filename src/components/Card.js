	...
	<div id="card-inner">
		<div id="card-top">
			...
			<div className="info">
				...
				<div className="country"><div></div></div>
				<div className="club"><div></div></div>				
			</div>
		...
		<div id="card-bottom">
			...
			<div className="stats">
				<div>
					<ul>
						<li><span>{user.THERating}</span><span>THE</span></li>
						<li><span>{user.DRIRating}</span><span>DRI</span></li>
						
					</ul>
				</div>
				<div>
					<ul>
						<li><span>{user.PHYRating}</span><span>PHY</span></li>
						<li><span>{user.BALRating}</span><span>BAL</span></li>
